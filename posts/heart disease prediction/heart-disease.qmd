...
| **Random Forest**    |**0.8152**| 0.8758 | 0.8072    | 0.8401   | 0.8078    |
...
- Precision and Recall: Random Forest and KNN showed similar recall rates (89.54%), indicating their ability to capture positive cases, while Random Forest exhibited higher precision (80.72%) compared to KNN (78.29%) and Logistic Regression (78.24%).
